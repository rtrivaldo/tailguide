    ...
    <>
      ...
      >
        ...
        <div className='flex flex-col gap-2 font-semibold text-xl mt-20 pl-6 text-zinc-500'>
          <Link
            href={'/'}
            className={`${
              pathname === '/' ? 'text-slate-950 dark:text-slate-100' : ''
            }`}
          ...
          <Link
            href={'/shadow'}
            className={`${
              pathname === '/shadow' ? 'text-slate-950 dark:text-slate-100' : ''
            }`}
            onClick={handleToggle}
          >
            Box Shadow
      ...
      <div className='fixed inset-x-0 flex justify-between items-center xl:container mx-auto px-4 md:px-6 py-6 bg-slate-50 dark:bg-zinc-900 transition-colors duration-300 ease-out'>
        ...
        <div className='flex items-center text-xl'>
          {/* github repo */}
          <Link
            href={'https://github.com/rtrivaldo/tailguide'}
            className='p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md transition-all duration-300 ease-out'
          >
            <FaGithub />
          </Link>
          ...
          {/* dark mode toggle */}
          <div
            className='p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md cursor-pointer dark:hidden group transition-all duration-300 ease-out'
            onClick={() => setTheme('dark')}
          >
            <IoSunnyOutline className='group-hover:rotate-90 transition-transform duration-300 ease-out' />
          </div>
          <div
            className='p-2 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-md cursor-pointer hidden dark:block group transition-all duration-300 ease-out'
