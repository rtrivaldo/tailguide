    ...
    <main className='flex flex-col md:flex-row gap-10 md:h-screen pt-20 pb-10 transition-colors duration-300 ease-out'>
        ...
        <div className='h-full min-h-[20em] lg:h-2/3 flex justify-center items-center bg-slate-100 dark:bg-zinc-800 shadow-md p-6 rounded-lg'>
          ...
          >
            <p className='text-sm lg:text-base'>
              ...
              Distinctio consequuntur, nihil voluptatibus deleniti accusamus cum
              quam explicabo tenetur commodi quo!
            </p>
          </div>
        </div>
          ...
          <div className=''>
            ...
            <div className='mt-2 flex items-center justify-between gap-6 bg-slate-50 dark:bg-zinc-900 p-4 rounded-lg shadow-md'>
              <input
                ...
                value={`shadow-[${
                  isInset ? 'inset_' : ''
                }${xValue}px_${yValue}px_${blurValue}px_${spreadValue}px_${getColorDisplay()}]`}
          ...
          <div className='mt-4'>
            ...
            <div className='mt-2 flex items-center justify-between gap-6 bg-slate-50 dark:bg-zinc-900 p-4 rounded-lg shadow-md'>
              <input
                type='text'
                readOnly
                value={`box-shadow: ${xValue}px ${yValue}px ${blurValue}px ${spreadValue}px ${getColorDisplay()}${
                  isInset ? ' inset' : ''
                };`}
                className='w-full bg-transparent focus:outline-none'
                ref={cssCode}
      ...
      <div className='md:w-1/2 lg:w-1/3 bg-slate-100 dark:bg-zinc-800 shadow-md p-6 rounded-lg'>
        ...
        <div className='mt-6'>
          <SliderInput
            state={xValue}
            handler={value => handleSlider(value, 'x')}
          ...
          <SliderInput
            state={yValue}
            handler={value => handleSlider(value, 'y')}
          ...
          <SliderInput
            state={spreadValue}
            handler={value => handleSlider(value, 'spread')}
            title={'Spread Radius'}
            defaultValue={5}
            value={spreadValue}
            max={150}
