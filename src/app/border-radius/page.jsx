                ...
                <div className="h-full lg:h-1/3 bg-slate-100 dark:bg-zinc-800 shadow-md p-6 rounded-lg">
                    <div className="">
                        ...
                        <div className="mt-2 flex items-center justify-between gap-6 bg-slate-50 dark:bg-zinc-900 p-4 rounded-lg shadow-md">
                            <input type="text" readOnly value={`rounded-[${topLeftValue}px_${topRightValue}px_${bottomRightValue}px_${bottomLeftValue}px]"`} className="w-full bg-transparent focus:outline-none" ref={tailwindCode} />
                    ...
                    <div className="mt-4">
                        ...
                        <div className="mt-2 flex items-center justify-between gap-6 bg-slate-50 dark:bg-zinc-900 p-4 rounded-lg shadow-md">
                            <input type="text" readOnly value={`border-radius: ${topLeftValue}px ${topRightValue}px ${bottomRightValue}px ${bottomLeftValue}px;`} className="w-full bg-transparent focus:outline-none" ref={cssCode} />
